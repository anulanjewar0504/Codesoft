...
public class CourseRegistrationSystem {
    public static void main(String[] args) {
        ...
        courses.add(new Course("CSCI101", "Introduction to Programming", "Learn the basics of programming.", 50,
                "Mon/Wed 9:00 AM - 10:30 AM"));
        courses.add(new Course("ISDSA100", "Data Structures and Algorithm", "Study Data Structures and Algorithms", 40,
                "Tue/Thu 11:00 AM - 12:30 PM"));
        courses.add(new Course("PHYS301", "Physics Mechanics", "Explore classical mechanics.", 30,
